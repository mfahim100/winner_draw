...
class PaymentJazzCashDialogBox extends StatelessWidget {

  PaymentJazzCashDialogBox({super.key});
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        NeumorphicText(
                          "Jazz cash Wallet Number: 0319-5652436",
                        ...
                        GestureDetector(
                          onTap: () async {
                            await Clipboard.setData(const ClipboardData(text: "03179528357"));
                            // copied successfully
                          },
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        NeumorphicText(
                          "Jazz cash Wallet Name: Adnan Khan",
                          textStyle: NeumorphicTextStyle(
                              fontSize: 15.sp, fontWeight: FontWeight.bold),
                          style: const NeumorphicStyle(color: Colors.white),
                        ),
                  ...
                  NeumorphicText(
                    " توجہ ! براہ مہربانی نوٹ فرمائیں ۔خبر دار! پیارے صارفین ایزی پپیہا اور بینک سے پیمنٹ بھیجنا منع ہے جاز کیش کاؤنٹ میں صرف جاز کیش اکاؤنٹ کا ہی استعمال کرے۔ ورنہ آپ کی رقم ضائع ہو جاۓ گے جسکے بعد میں کمپنی زمہ دار نہیں ہوگی شکریہ۔",
                    textStyle: NeumorphicTextStyle(
                        fontSize: 16.sp, fontWeight: FontWeight.bold),
                    style: const NeumorphicStyle(color: Colors.white),
                  ),
